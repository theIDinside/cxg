...
pub extern "system" fn gl_debug_output(source: gl::types::GLenum, source_type: gl::types::GLenum, id: u32, severity: gl::types::GLenum, _length: gl::types::GLsizei, message: *const std::os::raw::c_char, _user_param: *mut std::ffi::c_void) {
    ...
    let message = unsafe {
        std::ffi::CStr::from_ptr(message).to_str().expect("Failed to cast CStr to String")
    };
